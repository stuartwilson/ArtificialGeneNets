...
# Note this is a bit odd!!
src = [ 'configs/config2out1ctxt.json',
        s+'19_46_c.h5', # ctrl          Id2 at P36
        s+'19_47_c.h5', # p4 enucleate  Id2 at P36
        s+'19_46_c.h5', # ctrl          Id2 at P36
        s+'17_290_c.h5' # p12 enucleate Id2 at P36
        ]
...
run2([minNodes,maxNodes],Nbatch,Nsims,t,src,dst)
